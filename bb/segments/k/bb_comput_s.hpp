...
#ifndef _HPP_BB_SEGMENTS_K_COMPUT_S
#define _HPP_BB_SEGMENTS_K_COMPUT_S
      ...
      void gen_bk128_tc4_r257_r512_orig(
          ...
          if (bin_it < bin_size) {
              ...
              if (sml_warp) {
                  ...
                  rg_k0 = (sml_len + tid1 + (big_warp_id << 7) + 0 < seg_size) ? key[k + sml_len + tid1 +
                                                                                     (big_warp_id << 7) + 0] : bb::numeric_limits::max<K>();
                  rg_k1 = (sml_len + tid1 + (big_warp_id << 7) + 32 < seg_size) ? key[k + sml_len + tid1 +
                                                                                      (big_warp_id << 7) + 32]
                                                                                : bb::numeric_limits::max<K>();
