...
#ifndef _HPP_BB_MATRIX_K_COMPUT_L
#define _HPP_BB_MATRIX_K_COMPUT_L
...
namespace bb {
  namespace matrix {
    namespace k {
      ...
      template<class K>
      __global__
      void kern_block_sort(K *key, K *keyB,
      ...
      template<class K>
      __global__
      void kern_block_merge(K *keys, K *keysB, int *bin,
      ...
      template<class K>
      __global__
      void kern_copy(K *srck, K *dstk, int *bin,
      ...
      int gen_grid_kern_r2049(K *keys_d, K *keysB_d,
        ...
        blocks.x = 512;
        grids.x = blk_num;
        kern_block_sort << < grids, blocks >> > (keys_d, keysB_d, bin_d,
        ...
        while (stride < max_segsize) {
          kern_block_merge << < grids, blocks >> > (keys_d, keysB_d, bin_d,
        ...
        kern_copy << < grids, blocks >> > (srck, dstk, bin_d,
