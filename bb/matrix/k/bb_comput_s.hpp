...
#ifndef _HPP_BB_MATRIX_K_COMPUT_S
#define _HPP_BB_MATRIX_K_COMPUT_S
...
namespace bb {
  namespace matrix {
    namespace k {
      ...
      __global__
      void gen_copy(
          K *key, K *keyB, const int rows, const int cols, int *bin, int bin_size) {
      ...
      void gen_bk128_wp2_tc4_r5_r8_orig(
        ...
        if (bin_it < bin_size) {
          ...
          // exch_intxn: switch to exch_local()
          CMP_SWP_K(K, rg_k0, rg_k3);
          CMP_SWP_K(K, rg_k1, rg_k2);
          // exch_paral: switch to exch_local()
          CMP_SWP_K(K, rg_k0, rg_k1);
          CMP_SWP_K(K, rg_k2, rg_k3);
          // exch_intxn: generate exch_intxn()
          exch_intxn(rg_k0, rg_k1, rg_k2, rg_k3,
                     0x1, bit1);
          // exch_paral: switch to exch_local()
          CMP_SWP_K(K, rg_k0, rg_k2);
          CMP_SWP_K(K, rg_k1, rg_k3);
          // exch_paral: switch to exch_local()
          CMP_SWP_K(K, rg_k0, rg_k1);
          CMP_SWP_K(K, rg_k2, rg_k3);
      ...
      void gen_bk128_wp4_tc4_r9_r16_strd(
        ...
        if (bin_it < normalized_bin_size) {
          ...
          if (lane_id & 0x1) SWP_K(K, rg_k0, rg_k1);
          if (lane_id & 0x1) SWP_K(K, rg_k2, rg_k3);
          rg_k1 = __shfl_xor(rg_k1, 0x1);
          rg_k3 = __shfl_xor(rg_k3, 0x1);
          rg_k2 = __shfl_xor(rg_k2, 0x2);
          rg_k3 = __shfl_xor(rg_k3, 0x2);
          if (lane_id & 0x2) SWP_K(K, rg_k0, rg_k2);
          if (lane_id & 0x2) SWP_K(K, rg_k1, rg_k3);
          rg_k2 = __shfl_xor(rg_k2, 0x2);
          rg_k3 = __shfl_xor(rg_k3, 0x2);
          rg_k1 = __shfl_xor(rg_k1, 0x4);
          rg_k3 = __shfl_xor(rg_k3, 0x4);
          if (lane_id & 0x4) SWP_K(K, rg_k0, rg_k1);
          if (lane_id & 0x4) SWP_K(K, rg_k2, rg_k3);
          rg_k1 = __shfl_xor(rg_k1, 0x4);
          rg_k3 = __shfl_xor(rg_k3, 0x4);
          rg_k2 = __shfl_xor(rg_k2, 0x8);
          rg_k3 = __shfl_xor(rg_k3, 0x8);
          if (lane_id & 0x8) SWP_K(K, rg_k0, rg_k2);
          if (lane_id & 0x8) SWP_K(K, rg_k1, rg_k3);
          rg_k2 = __shfl_xor(rg_k2, 0x8);
          rg_k3 = __shfl_xor(rg_k3, 0x8);
          rg_k1 = __shfl_xor(rg_k1, 0x10);
          rg_k3 = __shfl_xor(rg_k3, 0x10);
          if (lane_id & 0x10) SWP_K(K, rg_k0, rg_k1);
          if (lane_id & 0x10) SWP_K(K, rg_k2, rg_k3);
          rg_k1 = __shfl_xor(rg_k1, 0x10);
          rg_k3 = __shfl_xor(rg_k3, 0x10);
          int kk;
          int ss;
      ...
      void gen_bk256_wp8_tc16_r65_r128_strd(
        ...
        if (bin_it < bin_size) {
          ...
          CMP_SWP_K(K, rg_k0, rg_k1);
          CMP_SWP_K(K, rg_k2, rg_k3);
          CMP_SWP_K(K, rg_k4, rg_k5);
          CMP_SWP_K(K, rg_k6, rg_k7);
          CMP_SWP_K(K, rg_k8, rg_k9);
          CMP_SWP_K(K, rg_k10, rg_k11);
          CMP_SWP_K(K, rg_k12, rg_k13);
          CMP_SWP_K(K, rg_k14, rg_k15);
          // exch_intxn: switch to exch_local()
          CMP_SWP_K(K, rg_k0, rg_k3);
          CMP_SWP_K(K, rg_k1, rg_k2);
          CMP_SWP_K(K, rg_k4, rg_k7);
          CMP_SWP_K(K, rg_k5, rg_k6);
          CMP_SWP_K(K, rg_k8, rg_k11);
          CMP_SWP_K(K, rg_k9, rg_k10);
          CMP_SWP_K(K, rg_k12, rg_k15);
          CMP_SWP_K(K, rg_k13, rg_k14);
          // exch_paral: switch to exch_local()
          CMP_SWP_K(K, rg_k0, rg_k1);
          CMP_SWP_K(K, rg_k2, rg_k3);
          CMP_SWP_K(K, rg_k4, rg_k5);
          ...
          CMP_SWP_K(K, rg_k14, rg_k15);
          // exch_intxn: switch to exch_local()
          CMP_SWP_K(K, rg_k0, rg_k7);
          CMP_SWP_K(K, rg_k1, rg_k6);
          CMP_SWP_K(K, rg_k2, rg_k5);
          CMP_SWP_K(K, rg_k3, rg_k4);
          CMP_SWP_K(K, rg_k8, rg_k15);
          CMP_SWP_K(K, rg_k9, rg_k14);
          CMP_SWP_K(K, rg_k10, rg_k13);
          CMP_SWP_K(K, rg_k11, rg_k12);
          // exch_paral: switch to exch_local()
          CMP_SWP_K(K, rg_k0, rg_k2);
          CMP_SWP_K(K, rg_k1, rg_k3);
          CMP_SWP_K(K, rg_k4, rg_k6);
          CMP_SWP_K(K, rg_k5, rg_k7);
          CMP_SWP_K(K, rg_k8, rg_k10);
          CMP_SWP_K(K, rg_k9, rg_k11);
          CMP_SWP_K(K, rg_k12, rg_k14);
          CMP_SWP_K(K, rg_k13, rg_k15);
          // exch_paral: switch to exch_local()
          CMP_SWP_K(K, rg_k0, rg_k1);
          CMP_SWP_K(K, rg_k2, rg_k3);
          CMP_SWP_K(K, rg_k4, rg_k5);
          ...
          CMP_SWP_K(K, rg_k14, rg_k15);
          // exch_intxn: switch to exch_local()
          CMP_SWP_K(K, rg_k0, rg_k15);
          CMP_SWP_K(K, rg_k1, rg_k14);
          CMP_SWP_K(K, rg_k2, rg_k13);
          CMP_SWP_K(K, rg_k3, rg_k12);
          CMP_SWP_K(K, rg_k4, rg_k11);
          CMP_SWP_K(K, rg_k5, rg_k10);
          CMP_SWP_K(K, rg_k6, rg_k9);
          CMP_SWP_K(K, rg_k7, rg_k8);
          // exch_paral: switch to exch_local()
          CMP_SWP_K(K, rg_k0, rg_k4);
          CMP_SWP_K(K, rg_k1, rg_k5);
          CMP_SWP_K(K, rg_k2, rg_k6);
          CMP_SWP_K(K, rg_k3, rg_k7);
          CMP_SWP_K(K, rg_k8, rg_k12);
          CMP_SWP_K(K, rg_k9, rg_k13);
          CMP_SWP_K(K, rg_k10, rg_k14);
          CMP_SWP_K(K, rg_k11, rg_k15);
          // exch_paral: switch to exch_local()
          CMP_SWP_K(K, rg_k0, rg_k2);
          CMP_SWP_K(K, rg_k1, rg_k3);
          CMP_SWP_K(K, rg_k4, rg_k6);
          ...
          exch_intxn(rg_k0, rg_k1, rg_k2, rg_k3, rg_k4, rg_k5, rg_k6, rg_k7,
                     ...
                     0x1, bit1);
          // exch_paral: switch to exch_local()
          CMP_SWP_K(K, rg_k0, rg_k8);
          CMP_SWP_K(K, rg_k1, rg_k9);
          CMP_SWP_K(K, rg_k2, rg_k10);
          CMP_SWP_K(K, rg_k3, rg_k11);
          CMP_SWP_K(K, rg_k4, rg_k12);
          CMP_SWP_K(K, rg_k5, rg_k13);
          CMP_SWP_K(K, rg_k6, rg_k14);
          CMP_SWP_K(K, rg_k7, rg_k15);
          // exch_paral: switch to exch_local()
          CMP_SWP_K(K, rg_k0, rg_k4);
          CMP_SWP_K(K, rg_k1, rg_k5);
          CMP_SWP_K(K, rg_k2, rg_k6);
        ...
        if (bin_it < normalized_bin_size) {
          ...
          if (lane_id & 0x1) SWP_K(K, rg_k0, rg_k1);
          if (lane_id & 0x1) SWP_K(K, rg_k2, rg_k3);
          if (lane_id & 0x1) SWP_K(K, rg_k4, rg_k5);
          if (lane_id & 0x1) SWP_K(K, rg_k6, rg_k7);
          if (lane_id & 0x1) SWP_K(K, rg_k8, rg_k9);
          if (lane_id & 0x1) SWP_K(K, rg_k10, rg_k11);
          if (lane_id & 0x1) SWP_K(K, rg_k12, rg_k13);
          if (lane_id & 0x1) SWP_K(K, rg_k14, rg_k15);
          rg_k1 = __shfl_xor(rg_k1, 0x1);
          rg_k3 = __shfl_xor(rg_k3, 0x1);
          rg_k5 = __shfl_xor(rg_k5, 0x1);
          rg_k7 = __shfl_xor(rg_k7, 0x1);
          ...
          if (lane_id & 0x2) SWP_K(K, rg_k0, rg_k2);
          if (lane_id & 0x2) SWP_K(K, rg_k1, rg_k3);
          if (lane_id & 0x2) SWP_K(K, rg_k4, rg_k6);
          if (lane_id & 0x2) SWP_K(K, rg_k5, rg_k7);
          if (lane_id & 0x2) SWP_K(K, rg_k8, rg_k10);
          if (lane_id & 0x2) SWP_K(K, rg_k9, rg_k11);
          if (lane_id & 0x2) SWP_K(K, rg_k12, rg_k14);
          if (lane_id & 0x2) SWP_K(K, rg_k13, rg_k15);
          rg_k2 = __shfl_xor(rg_k2, 0x2);
          rg_k3 = __shfl_xor(rg_k3, 0x2);
          rg_k6 = __shfl_xor(rg_k6, 0x2);
          rg_k7 = __shfl_xor(rg_k7, 0x2);
          ...
          if (lane_id & 0x4) SWP_K(K, rg_k0, rg_k4);
          if (lane_id & 0x4) SWP_K(K, rg_k1, rg_k5);
          if (lane_id & 0x4) SWP_K(K, rg_k2, rg_k6);
          if (lane_id & 0x4) SWP_K(K, rg_k3, rg_k7);
          if (lane_id & 0x4) SWP_K(K, rg_k8, rg_k12);
          if (lane_id & 0x4) SWP_K(K, rg_k9, rg_k13);
          if (lane_id & 0x4) SWP_K(K, rg_k10, rg_k14);
          if (lane_id & 0x4) SWP_K(K, rg_k11, rg_k15);
          rg_k4 = __shfl_xor(rg_k4, 0x4);
          rg_k5 = __shfl_xor(rg_k5, 0x4);
          rg_k6 = __shfl_xor(rg_k6, 0x4);
          rg_k7 = __shfl_xor(rg_k7, 0x4);
          ...
          if (lane_id & 0x8) SWP_K(K, rg_k0, rg_k8);
          if (lane_id & 0x8) SWP_K(K, rg_k1, rg_k9);
          if (lane_id & 0x8) SWP_K(K, rg_k2, rg_k10);
          if (lane_id & 0x8) SWP_K(K, rg_k3, rg_k11);
          if (lane_id & 0x8) SWP_K(K, rg_k4, rg_k12);
          if (lane_id & 0x8) SWP_K(K, rg_k5, rg_k13);
          if (lane_id & 0x8) SWP_K(K, rg_k6, rg_k14);
          if (lane_id & 0x8) SWP_K(K, rg_k7, rg_k15);
          rg_k8 = __shfl_xor(rg_k8, 0x8);
          rg_k9 = __shfl_xor(rg_k9, 0x8);
          rg_k10 = __shfl_xor(rg_k10, 0x8);
          rg_k11 = __shfl_xor(rg_k11, 0x8);
          ...
          if (lane_id & 0x10) SWP_K(K, rg_k0, rg_k1);
          if (lane_id & 0x10) SWP_K(K, rg_k2, rg_k3);
          if (lane_id & 0x10) SWP_K(K, rg_k4, rg_k5);
          if (lane_id & 0x10) SWP_K(K, rg_k6, rg_k7);
          if (lane_id & 0x10) SWP_K(K, rg_k8, rg_k9);
          if (lane_id & 0x10) SWP_K(K, rg_k10, rg_k11);
          if (lane_id & 0x10) SWP_K(K, rg_k12, rg_k13);
          if (lane_id & 0x10) SWP_K(K, rg_k14, rg_k15);
          rg_k1 = __shfl_xor(rg_k1, 0x10);
          rg_k3 = __shfl_xor(rg_k3, 0x10);
          rg_k5 = __shfl_xor(rg_k5, 0x10);
          rg_k7 = __shfl_xor(rg_k7, 0x10);
      ...
      void gen_bk256_wp32_tc8_r129_r256_strd(
        ...
        if (bin_it < normalized_bin_size) {
          ...
          if (lane_id & 0x8) SWP_K(K, rg_k0, rg_k1);
          if (lane_id & 0x8) SWP_K(K, rg_k2, rg_k3);
          if (lane_id & 0x8) SWP_K(K, rg_k4, rg_k5);
          if (lane_id & 0x8) SWP_K(K, rg_k6, rg_k7);
          rg_k1 = __shfl_xor(rg_k1, 0x8);
          rg_k3 = __shfl_xor(rg_k3, 0x8);
          rg_k5 = __shfl_xor(rg_k5, 0x8);
          rg_k7 = __shfl_xor(rg_k7, 0x8);
          ...
          rg_k7 = __shfl_xor(rg_k7, 0x10);
          if (lane_id & 0x10) SWP_K(K, rg_k0, rg_k2);
          if (lane_id & 0x10) SWP_K(K, rg_k1, rg_k3);
          if (lane_id & 0x10) SWP_K(K, rg_k4, rg_k6);
          if (lane_id & 0x10) SWP_K(K, rg_k5, rg_k7);
          rg_k2 = __shfl_xor(rg_k2, 0x10);
          rg_k3 = __shfl_xor(rg_k3, 0x10);
          rg_k6 = __shfl_xor(rg_k6, 0x10);
          rg_k7 = __shfl_xor(rg_k7, 0x10);
